...
public class ShowHistoryController implements Initializable {
    ...
    public TableView tableShowDetails;
    public TableColumn IDColoumn;
    public TableColumn NameColoumn;
    public TableColumn ColorColumn;
    public TableColumn SizeColoumn;
    public TableColumn PriceColoumn;
    public TableColumn StockColoumn;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ArrayList<Carpets> readCarpetFromFile =FileHandling.readFromFile("src/main/java/com/example/oopproject/CarpetHistory.txt");
